...
MODEL                := Zbiorniki
MODULES              := Zbiorniki_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Zbiorniki.mk
...
#
MODELLIB                  := Zbiornikilib.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Zbiorniki_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/LABORA~1/RODA10~1/PIDNAZ~1/Zbiorniki_sldrt_win64;E:/LABORA~1/RODA10~1/PIDNAZ~1;E:/LABORA~1/RODA10~1/IDENTY~2;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common

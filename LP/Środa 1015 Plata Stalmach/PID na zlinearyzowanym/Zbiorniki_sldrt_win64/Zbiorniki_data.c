...
P_Zbiorniki_T Zbiorniki_P = {
  ...
  0.01,                                /* Variable: T0
                                        ...
                                        *   '<S10>/RT-DAC PCI PWM '
                                        */
  1433.5067,                           /* Mask Parameter: PIDController1_D
                                        * Referenced by: '<S1>/Derivative Gain'
                                        */
  0.18023,                             /* Mask Parameter: PIDController1_I
                                        * Referenced by: '<S1>/Integral Gain'
                                        */
  45.0,                                /* Mask Parameter: PIDController1_LowerSaturationL
                                        * Referenced by: '<S1>/Saturate'
                                        */
  2.9092,                              /* Mask Parameter: PIDController1_N
                                        * Referenced by: '<S1>/Filter Coefficient'
                                        */
  32.2909,                             /* Mask Parameter: PIDController1_P
                                        * Referenced by: '<S1>/Proportional Gain'
                                        */
  160.0,                               /* Mask Parameter: PIDController1_UpperSaturationL
                                        * Referenced by: '<S1>/Saturate'
                                        */

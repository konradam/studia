...
void Zbiorniki_output(void)
{
  ...
  if (rtmIsMajorTimeStep(Zbiorniki_M) &&
     ...
     */
    Zbiorniki_B.SliderGain_ay = Zbiorniki_P.Pompa_gain *
...
RT_MODEL_Zbiorniki_T *Zbiorniki(void)
{
  ...
  /* External mode info */
  Zbiorniki_M->Sizes.checksums[0] = (3115259166U);
  Zbiorniki_M->Sizes.checksums[1] = (431828842U);
  Zbiorniki_M->Sizes.checksums[2] = (716045333U);
  Zbiorniki_M->Sizes.checksums[3] = (3069286899U);
    ...
    /* Level2 S-Function Block: Zbiorniki/<S7>/RT-DAC PCI PWM  (rtdacpci_pwm) */
    {
      ...
      /* inputs */
      {
        ...
        /* port 0 */
        {
          ...
          sfcnUPtrs[0] = &Zbiorniki_B.SliderGain_ay;
          ssSetInputPortSignalPtrs(rts, 0, (InputPtrsType)&sfcnUPtrs[0]);
          _ssSetInputPortNumDimensions(rts, 0, 1);
          ssSetInputPortWidth(rts, 0, 1);
        }
  ...
  /* Initialize Sizes */
  Zbiorniki_M->Sizes.numContStates = (3);/* Number of continuous states */
  ...
  Zbiorniki_M->Sizes.numBlocks = (27); /* Number of blocks */
  Zbiorniki_M->Sizes.numBlockIO = (11);/* Number of block outputs */
  Zbiorniki_M->Sizes.numBlockPrms = (111);/* Sum of parameter "widths" */
  return Zbiorniki_M;
}

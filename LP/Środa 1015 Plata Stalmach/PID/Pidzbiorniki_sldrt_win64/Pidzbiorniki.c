...
void Pidzbiorniki_output(void)
{
   ...
   *  Sum: '<S1>/SumD'
   */
  Pidzbiorniki_B.FilterCoefficient = (Pidzbiorniki_P.PIDController_D * rtb_Sum3
    - Pidzbiorniki_X.Filter_CSTATE) * Pidzbiorniki_P.PIDController_N;

  /* Sum: '<S1>/Sum' incorporates:
   *  Gain: '<S1>/Proportional Gain'
   *  Integrator: '<S1>/Integrator'
   */
  u0 = (Pidzbiorniki_P.PIDController_P * rtb_Sum3 +
        Pidzbiorniki_X.Integrator_CSTATE) + Pidzbiorniki_B.FilterCoefficient;

  /* Saturate: '<S1>/Saturate' */
  if (u0 > Pidzbiorniki_P.PIDController_UpperSaturationLi) {
    Pidzbiorniki_B.Saturate = Pidzbiorniki_P.PIDController_UpperSaturationLi;
  } else if (u0 < Pidzbiorniki_P.PIDController_LowerSaturationLi) {
    Pidzbiorniki_B.Saturate = Pidzbiorniki_P.PIDController_LowerSaturationLi;
  } else {
  ...
  Pidzbiorniki_B.IntegralGain = Pidzbiorniki_P.PIDController_I * rtb_Sum3;
  if (rtmIsMajorTimeStep(Pidzbiorniki_M) &&
      Pidzbiorniki_M->Timing.TaskCounters.TID[1] == 0) {
  }
}
...
RT_MODEL_Pidzbiorniki_T *Pidzbiorniki(void)
{
  ...
  Pidzbiorniki_P.PIDController_UpperSaturationLi = rtInf;
  ...
  /* External mode info */
  Pidzbiorniki_M->Sizes.checksums[0] = (1544327180U);
  Pidzbiorniki_M->Sizes.checksums[1] = (3995782684U);
  Pidzbiorniki_M->Sizes.checksums[2] = (695235259U);
  Pidzbiorniki_M->Sizes.checksums[3] = (4237796929U);

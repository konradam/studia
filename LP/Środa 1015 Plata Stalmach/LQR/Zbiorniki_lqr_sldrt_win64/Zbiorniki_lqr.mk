...
MODEL                := Zbiorniki_lqr
MODULES              := Zbiorniki_lqr_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Zbiorniki_lqr.mk
...
#
MODELLIB                  := Zbiorniki_lqrlib.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Zbiorniki_lqr_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/LABORA~1/RODA10~1/LQR/Zbiorniki_lqr_sldrt_win64;E:/LABORA~1/RODA10~1/LQR;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common

...
MODEL                := Pidzbiorniki
MODULES              := Pidzbiorniki_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Pidzbiorniki.mk
...
#
MODELLIB                  := Pidzbiornikilib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Pidzbiorniki_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/LABORA~1/RODA10~1/LQR/Pidzbiorniki_sldrt_win64;E:/LABORA~1/RODA10~1/LQR;E:/LABORA~1/RODA10~1/PID;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common

  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% Pidzbiorniki_P.PIDController4_D
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 3;
	
	  ;% Pidzbiorniki_P.PIDController4_I
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 4;
	
	  ;% Pidzbiorniki_P.PIDController4_LowerSaturationL
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 5;
	
	  ;% Pidzbiorniki_P.PIDController4_N
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 6;
	
	  ;% Pidzbiorniki_P.PIDController4_P
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 7;
	
	  ;% Pidzbiorniki_P.PIDController4_UpperSaturationL
  ...
  targMap.checksum0 = 4049100544;
  targMap.checksum1 = 2115925076;
  targMap.checksum2 = 1390645455;
  targMap.checksum3 = 414745005;

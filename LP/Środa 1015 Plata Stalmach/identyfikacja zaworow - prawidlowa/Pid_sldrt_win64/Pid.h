...
#define Pid_rtModel                    RT_MODEL_Pid_T
...
#define rtB                            Pid_B
#define BlockIO                        B_Pid_T
#define rtX                            Pid_X
#define ContinuousStates               X_Pid_T
#define rtXdot                         Pid_XDot
#define StateDerivatives               XDot_Pid_T
#define tXdis                          Pid_XDis
#define StateDisabled                  XDis_Pid_T
#define rtP                            Pid_P
#define Parameters                     P_Pid_T
#define rtDWork                        Pid_DW
#define D_Work                         DW_Pid_T
 ...
 * '<S2>'   : 'Pid/Power Output'
 * '<S3>'   : 'Pid/The Levels of Tanks'
 * '<S4>'   : 'Pid/Zawor - DOL'
 * '<S5>'   : 'Pid/Zawor - GORA'
 * '<S6>'   : 'Pid/Zawor - SRODEK'
 * '<S7>'   : 'Pid/Power Output/POMP PWM 3'
 * '<S8>'   : 'Pid/Power Output/VALVE Down PWM 2'
 * '<S9>'   : 'Pid/Power Output/VALVE Middle PWM 1'
 * '<S10>'  : 'Pid/Power Output/VALVE Upper PWM 0'
 * '<S11>'  : 'Pid/The Levels of Tanks/RT-DAC Analog Inputs'
 */

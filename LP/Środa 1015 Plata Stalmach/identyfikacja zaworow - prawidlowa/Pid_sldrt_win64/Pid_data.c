...
P_Pid_T Pid_P = {
  ...
  0.01,                                /* Variable: T0
                                        ...
                                        *   '<S10>/RT-DAC PCI PWM '
                                        */
  255498.0,                            /* Mask Parameter: PIDController_D
                                        * Referenced by: '<S1>/Derivative Gain'
                                        */
  38.06,                               /* Mask Parameter: PIDController_I
                                        * Referenced by: '<S1>/Integral Gain'
                                        */
  0.0,                                 /* Mask Parameter: PIDController_LowerSaturationLi
                                        * Referenced by: '<S1>/Saturate'
                                        */
  2.41,                                /* Mask Parameter: PIDController_N
                                        * Referenced by: '<S1>/Filter Coefficient'
                                        */
  6253.08,                             /* Mask Parameter: PIDController_P
                                        * Referenced by: '<S1>/Proportional Gain'
                                        */
  160.0,                               /* Mask Parameter: PIDController_UpperSaturationLi
                                        * Referenced by: '<S1>/Saturate'
                                        */

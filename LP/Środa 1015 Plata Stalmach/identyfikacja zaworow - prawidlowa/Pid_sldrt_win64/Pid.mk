...
MODEL                := Pid
MODULES              := Pid_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Pid.mk
...
#
MODELLIB                  := Pidlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Pid_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/LABORA~1/RODA10~1/IDENTY~2/Pid_sldrt_win64;E:/LABORA~1/RODA10~1/IDENTY~2;E:/LABORA~1/RODA10~1;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common

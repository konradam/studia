  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% Pid_P.PIDController_D
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 3;
	
	  ;% Pid_P.PIDController_I
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 4;
	
	  ;% Pid_P.PIDController_LowerSaturationLi
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 5;
	
	  ;% Pid_P.PIDController_N
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 6;
	
	  ;% Pid_P.PIDController_P
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 7;
	
	  ;% Pid_P.PIDController_UpperSaturationLi
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 8;
	
	  ;% Pid_P.ZaworGORA_gain
	  section.data(9).logicalSrcIdx = 8;
	  section.data(9).dtTransOffset = 9;
	
	  ;% Pid_P.ZaworSRODEK_gain
	  ...
	  ;% Pid_P.RTDACAnalogInputs_P1_Size
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 12;
	
	  ;% Pid_P.RTDACAnalogInputs_P1
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 14;
	
	  ;% Pid_P.RTDACAnalogInputs_P2_Size
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 15;
	
	  ;% Pid_P.RTDACAnalogInputs_P2
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 17;
	
	  ;% Pid_P.RTDACAnalogInputs_P3_Size
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 20;
	
	  ;% Pid_P.RTDACAnalogInputs_P3
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 22;
	
	  ;% Pid_P.RTDACAnalogInputs_P4_Size
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 25;
	
	  ;% Pid_P.RTDACAnalogInputs_P4
	  section.data(19).logicalSrcIdx = 18;
	  section.data(19).dtTransOffset = 27;
	
	  ;% Pid_P.Constant_Value
	  ...
	  ;% Pid_P.TransferFcn1_A
	  section.data(85).logicalSrcIdx = 84;
	  section.data(85).dtTransOffset = 117;
	
	  ;% Pid_P.TransferFcn1_C
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% Pid_DW.Scope_PWORK.LoggedData
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Pid_DW.Scope2_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Pid_DW.Scope1_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 2;
  ...
  targMap.checksum0 = 3344005174;
  targMap.checksum1 = 1923773845;
  targMap.checksum2 = 4120447284;
  targMap.checksum3 = 1532527456;

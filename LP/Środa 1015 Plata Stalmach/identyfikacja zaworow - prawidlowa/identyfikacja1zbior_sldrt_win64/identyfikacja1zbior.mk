...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2015A~1/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := identyfikacja1zbior
MODULES              := identyfikacja1zbior_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := identyfikacja1zbior.mk
MATLAB_ROOT          := C:/PROGRA~1/MATLAB/R2015A~1
MATLAB_BIN           := C:/PROGRA~1/MATLAB/R2015A~1/bin
S_FUNCTIONS          := rtdacpci_analoginputs.c rtdacpci_pwm.c
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 3
TID01EQ              := 1
...
SLDRTDIR             := C:/PROGRA~1/MATLAB/R2015A~1/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
#
MODELLIB                  := identyfikacja1zbiorlib.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := identyfikacja1zbior_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/LABORA~1/RODA10~1/IDENTY~2/identyfikacja1zbior_sldrt_win64;E:/LABORA~1/RODA10~1/IDENTY~2;E:/LABORA~1/RODA10~1;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
## RTDAC_PCI start
USER_INCLUDES = include-$(MATLAB_ROOT)/toolbox/RTDAC_PCI/blocks/src
## RTDAC_PCI end
...
%.obj : $(MATLAB_ROOT)/simulink/src/%.cpp
	$(call BUILDOBJ, $(CPP))
## RTDAC_PCI start
%.obj : $(MATLAB_ROOT)/toolbox/RTDAC_PCI/blocks/src/%.c
	$(call BUILDOBJ, $(CC))
## RTDAC_PCI end

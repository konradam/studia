...
MODEL                := Zbiornikitst
MODULES              := Zbiornikitst_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Zbiornikitst.mk
...
#
MODELLIB                  := Zbiornikitstlib.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Zbiornikitst_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/LABORA~1/RODA10~1/Zbiornikitst_sldrt_win64;E:/LABORA~1/RODA10~1;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common

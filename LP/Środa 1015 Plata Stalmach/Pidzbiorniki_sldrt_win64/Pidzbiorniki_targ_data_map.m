  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% Pidzbiorniki_P.PIDController2_D
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 3;
	
	  ;% Pidzbiorniki_P.PIDController2_I
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 4;
	
	  ;% Pidzbiorniki_P.PIDController2_LowerSaturationL
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 5;
	
	  ;% Pidzbiorniki_P.PIDController2_N
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 6;
	
	  ;% Pidzbiorniki_P.PIDController2_P
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 7;
	
	  ;% Pidzbiorniki_P.PIDController2_UpperSaturationL
  ...
  targMap.checksum0 = 3703742145;
  targMap.checksum1 = 3610574043;
  targMap.checksum2 = 978701018;
  targMap.checksum3 = 539861720;

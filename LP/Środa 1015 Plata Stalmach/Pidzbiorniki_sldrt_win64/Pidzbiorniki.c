...
void Pidzbiorniki_output(void)
{
   ...
   */
  rtb_Sum3 = Pidzbiorniki_P.Constant4_Value - Pidzbiorniki_B.TransferFcn2;
   ...
   *  Sum: '<S1>/SumD'
   */
  Pidzbiorniki_B.FilterCoefficient = (Pidzbiorniki_P.PIDController2_D * rtb_Sum3
    - Pidzbiorniki_X.Filter_CSTATE) * Pidzbiorniki_P.PIDController2_N;

  /* Sum: '<S1>/Sum' incorporates:
   *  Gain: '<S1>/Proportional Gain'
   *  Integrator: '<S1>/Integrator'
   */
  u0 = (Pidzbiorniki_P.PIDController2_P * rtb_Sum3 +
        Pidzbiorniki_X.Integrator_CSTATE) + Pidzbiorniki_B.FilterCoefficient;

  /* Saturate: '<S1>/Saturate' */
  if (u0 > Pidzbiorniki_P.PIDController2_UpperSaturationL) {
    Pidzbiorniki_B.Saturate = Pidzbiorniki_P.PIDController2_UpperSaturationL;
  } else if (u0 < Pidzbiorniki_P.PIDController2_LowerSaturationL) {
    Pidzbiorniki_B.Saturate = Pidzbiorniki_P.PIDController2_LowerSaturationL;
  } else {
    Pidzbiorniki_B.Saturate = u0;
  }

  /* End of Saturate: '<S1>/Saturate' */

  /* Gain: '<Root>/Gain3' */
  Pidzbiorniki_B.Gain3 = Pidzbiorniki_P.Gain3_Gain * Pidzbiorniki_B.Saturate;
  if (rtmIsMajorTimeStep(Pidzbiorniki_M) &&
      Pidzbiorniki_M->Timing.TaskCounters.TID[1] == 0) {
  ...
  Pidzbiorniki_B.IntegralGain = Pidzbiorniki_P.PIDController2_I * rtb_Sum3;
  if (rtmIsMajorTimeStep(Pidzbiorniki_M) &&
      Pidzbiorniki_M->Timing.TaskCounters.TID[1] == 0) {
  }
}
...
RT_MODEL_Pidzbiorniki_T *Pidzbiorniki(void)
{
  ...
  /* External mode info */
  Pidzbiorniki_M->Sizes.checksums[0] = (3703742145U);
  Pidzbiorniki_M->Sizes.checksums[1] = (3610574043U);
  Pidzbiorniki_M->Sizes.checksums[2] = (978701018U);
  Pidzbiorniki_M->Sizes.checksums[3] = (539861720U);
  ...
  /* Initialize Sizes */
  Pidzbiorniki_M->Sizes.numContStates = (5);/* Number of continuous states */
  ...
  Pidzbiorniki_M->Sizes.numBlocks = (40);/* Number of blocks */
  Pidzbiorniki_M->Sizes.numBlockIO = (14);/* Number of block outputs */
  Pidzbiorniki_M->Sizes.numBlockPrms = (119);/* Sum of parameter "widths" */

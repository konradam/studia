...
RT_MODEL_Zbiorniki_T *Zbiorniki(void)
{
  ...
  /* External mode info */
  Zbiorniki_M->Sizes.checksums[0] = (268753180U);
  Zbiorniki_M->Sizes.checksums[1] = (30500407U);
  Zbiorniki_M->Sizes.checksums[2] = (2624192489U);
  Zbiorniki_M->Sizes.checksums[3] = (2232904599U);

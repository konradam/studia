...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&Zbiorniki1_B.RTDACAnalogInputs[0]), 0, 0, 10 }
  ,

  { (char_T *)(&Zbiorniki1_DWork.Scope_PWORK.LoggedData), 11, 0, 3 }
};
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&Zbiorniki1_P.RTDACAnalogInputs_P1_Size[0]), 0, 0, 114 }
};

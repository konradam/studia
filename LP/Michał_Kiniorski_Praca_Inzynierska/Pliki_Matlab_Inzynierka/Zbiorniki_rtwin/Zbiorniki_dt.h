...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&Zbiorniki_B.RTDACAnalogInputs[0]), 0, 0, 10 }
  ,

  { (char_T *)(&Zbiorniki_DWork.Scope_PWORK.LoggedData), 11, 0, 1 }
};
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&Zbiorniki_P.RTDACAnalogInputs_P1_Size[0]), 0, 0, 114 }
};
